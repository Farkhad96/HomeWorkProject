# Bank_Widget
Приложение создано для работы с банковскими данными и операциями клиента. На данном этапе может маскировать номера карты и счета, сортировать операции по дате и статусу, генерировать номер карты. Находится в разработке
