...
def filter_by_currency(list_of_transactions: list[dict], code_of_currency: str) -> Generator[dict]:
    ...
    filtered_transactions = filter(
        lambda x: x.get("operationAmount", {}).get("currency", {}).get("code", {}) == code_of_currency,
